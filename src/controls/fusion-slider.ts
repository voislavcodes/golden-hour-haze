...
@customElement('ghz-fusion-slider')
export class FusionSlider extends BaseControl {
  static styles = [
  ...
  connectedCallback() {
    ...
    this.value = sceneStore.get().fusion;
  ...
  render() {
    ...
    return html`
      <div class="slider-container glass">
        <span class="slider-label">fuse</span>
        <div
          class="slider-track"
...
declare global {
  interface HTMLElementTagNameMap {
    'ghz-fusion-slider': FusionSlider;
  }
}
